        ...
        if auth_mode == "Create Account":
            ...
            if st.button("Authenticate", use_container_width=True):
                if supabase:
                    ...
                    st.session_state.user = type('obj', (object,), {'email': email, 'id': 'local_user_' + email})()
                    st.session_state.user_role = role_selection
                    st.rerun()
    st.stop()
...
def generate_html_report(process_name, cfg, control_mode, Kp, Ki, Kd,
    ...
    if zn_result:
        ...
        <div style="margin-top:24px;">
            ...
            <table style="width:100%;border-collapse:collapse;background:rgba(15,22,35,0.6);border-radius:10px;overflow:hidden;">
                <thead>
                    <tr style="background:rgba(0,242,254,0.1);">
                        <th style="padding:10px 14px;text-align:left;font-size:11px;letter-spacing:1px;color:#8892A4;">PARAMETER</th>
                        <th style="padding:10px 14px;text-align:left;font-size:11px;letter-spacing:1px;color:#8892A4;">CLASSIC PID</th>
                        <th style="padding:10px 14px;text-align:left;font-size:11px;letter-spacing:1px;color:#8892A4;">PI OPTIMIZED</th>
                        <th style="padding:10px 14px;text-align:left;font-size:11px;letter-spacing:1px;color:#8892A4;">MODERN PID</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#E8ECF1;">Kp</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                    </tr>
                    <tr>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#E8ECF1;">Ki</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                    </tr>
                    <tr>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#E8ECF1;">Kd</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                        <td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td>
                    </tr>
            ...
            <p style="font-family:'JetBrains Mono',monospace;font-size:11px;color:#8892A4;margin-top:8px;">Ku = {} | Tu = {}s (Ultimate Gain & Period)</p>
        </div>""".format(
...
<title>NEXUS PID Test Certificate - {}</title>
<style>
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap');
...
th {{ background:rgba(0,242,254,0.1); padding:10px 14px; text-align:left; font-size:11px; letter-spacing:1px; color:#8892A4; }}
...
<div class="container">
    <div class="header">
        ...
        <p style="margin-top:8px;font-family:'JetBrains Mono',monospace;font-size:12px;color:#00F2FE;">Generated: {}</p>
    </div>

    <h2 class="section-title">Test Metadata</h2>
    <table>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Operator</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">{}</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Role</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">{}</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Process</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">{}</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Control Mode</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">{}</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Setpoint</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{} {}</td></tr>
    </table>
    ...
    <table>
        ...
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Kp</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Proportional Gain</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Ki</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Integral Gain</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Kd</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">Derivative Gain</td></tr>
    </table>
    ...
    <table>
        ...
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">IAE</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">error.s</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">ISE</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">error^2.s</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Overshoot</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}%</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">of setpoint</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Rise Time</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}s</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">0-90% target</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Settling Time</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}s</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">+/-2% band</td></tr>
        <tr><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;">Steady-State Error</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-family:'JetBrains Mono',monospace;font-size:13px;color:#00F2FE;">{}</td><td style="padding:10px 14px;border-bottom:1px solid rgba(255,255,255,0.06);font-size:13px;color:#8892A4;">{}</td></tr>
    </table>
    ...
    <div class="footer">
        NEXUS v4.0 | Industrial PID Operations Platform | Ali Nasreddine Benseffa | 2026
    </div>
</div>
</body>
</html>""".format(
        process_name, now, user_email, role, process_name, control_mode,
        target_setpoint, cfg['unit'],
        Kp, Ki, Kd,
        kpis['IAE'], kpis['ISE'], kpis['Overshoot'], kpis['Rise Time'],
        kpis['Settling Time'], kpis['Steady-State Error'], cfg['unit'],
        zn_section, critical_count, warning_count, optimal_count,
        alarm_rows if alarm_rows else '<tr><td colspan="4" style="padding:14px;text-align:center;color:#8892A4;font-size:13px;">No alarm events recorded.</td></tr>')
    return html
...
with st.sidebar:
    ...
    data_source = st.radio(
        ...
        disabled=not perms["can_change_data_source"] and st.session_state.user_role != "Plant Admin"
    )
    ...
    tuning_preset = st.selectbox("Tuning Preset", list(TUNING_PRESETS.keys()),
                                  disabled=not perms["can_tune_pid"])
    ...
    if perms["can_auto_tune"]:
        ...
        if "zn_result" in st.session_state and st.session_state.get("zn_applied") == selected_process:
            ...
            <div class="auto-tune-card">
                ...
                <div class="auto-tune-result">
                    ...
                    <div style="margin-bottom:4px;"><span style="color:#8892A4;">Classic PID:</span> Kp=<span style="color:#00FF88;">{}</span> Ki=<span style="color:#00FF88;">{}</span> Kd=<span style="color:#00FF88;">{}</span></div>
                    <div style="margin-bottom:4px;"><span style="color:#8892A4;">PI Optimized:</span> Kp=<span style="color:#00FF88;">{}</span> Ki=<span style="color:#00FF88;">{}</span> Kd=<span style="color:#00FF88;">0.0</span></div>
                    <div><span style="color:#8892A4;">Modern PID:</span> Kp=<span style="color:#00FF88;">{}</span> Ki=<span style="color:#00FF88;">{}</span> Kd=<span style="color:#00FF88;">{}</span></div>
                </div>
            </div>
            """.format(zn['Ku'], zn['Tu'],
                       zn['Classic_PID']['Kp'], zn['Classic_PID']['Ki'], zn['Classic_PID']['Kd'],
                       zn['PI_Optimized']['Kp'], zn['PI_Optimized']['Ki'],
                       zn['Modern_PID']['Kp'], zn['Modern_PID']['Ki'], zn['Modern_PID']['Kd']),
                       unsafe_allow_html=True)

            zn_choice = st.radio("Apply preset", ["Classic PID", "PI Optimized", "Modern PID"],
                                  key="zn_apply_choice", horizontal=True)
            if st.button("Apply Gains to Controller", use_container_width=True, key="zn_apply_btn"):
                chosen = zn["{}_{}".format(zn_choice.split()[0], zn_choice.split()[1])]
        ...
        st.info("Auto-Tuning requires Control Engineer or Plant Admin role.")

# ============================================================================
# HEADER BAR
# ============================================================================
if "Digital Twin" in data_source:
    source_label = "SIMULATION"
elif "Hardware" in data_source:
...
if "Hardware" in data_source:
    ...
    """.format(hw_status,
               '#00FF88' if hw_gateway.connected else '#FF3366',
               hw_status.upper(),
               hw_gateway.retries, hw_gateway.max_retries),
               unsafe_allow_html=True)
...
if "MQTT" in data_source:
    ...
    <div class="hw-status-bar">
        ...
        <span style="color: {};">{}</span>
        <span style="color: #8892A4; margin-left: auto;">MESSAGES: {}</span>
    </div>
    """.format(mqtt_status,
               '#00FF88' if mqtt_gateway.connected else '#FF3366',
               mqtt_status.upper(),
               mqtt_gateway.messages_received),
               unsafe_allow_html=True)
...
if has_critical:
    ...
    for msg in crit_msgs[:2]:
        ...
        """.format(msg), unsafe_allow_html=True)
elif has_warning:
    ...
    if opt_msgs:
        ...
        """.format(opt_msgs[0]), unsafe_allow_html=True)
...
with col1:
    ...
    """.format(final_pv, cfg['unit']), unsafe_allow_html=True)
...
with col2:
    ...
    """.format(target_setpoint, cfg['unit']), unsafe_allow_html=True)
...
with col3:
    ...
    """.format(sse_class, sse, cfg['unit']), unsafe_allow_html=True)
...
with col4:
    ...
    """.format(os_class, overshoot), unsafe_allow_html=True)
...
with col5:
    ...
    """.format(kpis['Final Output']), unsafe_allow_html=True)
...
with col_a:
    ...
    """.format(kpis['IAE']), unsafe_allow_html=True)
...
with col_b:
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-value" style="font-size: 22px;">{}</div>
        <div class="kpi-unit">error^2*seconds</div>
    </div>
    """.format(kpis['ISE']), unsafe_allow_html=True)
...
with col_c:
    ...
    """.format(kpis['Rise Time']), unsafe_allow_html=True)
...
with col_d:
    ...
    """.format(kpis['Settling Time']), unsafe_allow_html=True)
...
with main_tabs[tab_idx]:
    ...
    with col_dl1:
        st.download_button(
            ...
            data=csv_data,
            file_name="nexus_telemetry_{}_{}.csv".format(
                selected_process.split()[0].lower(), int(time.time())),
            mime="text/csv",
...
with main_tabs[tab_idx]:
    events = [
        ...
        {"time": "{}".format(time_data[-1]) if len(time_data) > 0 else "00:00.00",
         "event": "Simulation complete: SSE={}".format(kpis['Steady-State Error']),
    ...
    for evt in events:
        ...
        <div style="font-family: 'JetBrains Mono'; font-size: 12px; padding: 6px 0; 
            ...
            <span style="color: {}; margin: 0 8px;">{}</span>
            <span style="color: #E8ECF1;">{}</span>
        </div>
        """.format(evt['time'], color, evt['level'], evt['event']), unsafe_allow_html=True)
tab_idx += 1
...
if perms["can_export_report"]:
    with main_tabs[tab_idx]:
        ...
        report_html = generate_html_report(
            ...
            target_setpoint, kpis, alarm_events, zn_in_report, st.session_state.user_role
        )
        ...
        with col_r1:
            st.download_button(
                ...
                data=report_html,
                file_name="nexus_certificate_{}_{}.html".format(
                    selected_process.split()[0].lower(), int(time.time())),
                mime="text/html",
                use_container_width=True
            )
        with col_r2:
            st.download_button(
                ...
                data=report_html,
                file_name="nexus_pdf_{}_{}.html".format(
                    selected_process.split()[0].lower(), int(time.time())),
                mime="text/html",
                use_container_width=True
            )
